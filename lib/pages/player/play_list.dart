              ...
              Positioned(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                      ...
                      color: Colors.white),
                  child: Column(
                    children: [_Header(), _List(), _Footer()],
                  ),
                ),
              ),
            ],
              ...
              children: [
                Text.rich(TextSpan(children: [
                  ...
                  TextSpan(
                      text: ' (85)',
                      style: TextStyle(
                          fontSize: screen.calc(32), color: Color(0xff999999)))
                ])),
              ],
            ),
          ),
              ...
              children: [
                Row(
                  children: [
                    Icon(Icons.loop),
                    Container(
                        padding: EdgeInsets.only(left: screen.calc(20)),
                        child: Text('列表循环')),
                  ],
                ),
                Spacer(),
  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: SingleChildScrollView(
        child: Container(
            padding:
                EdgeInsets.only(left: screen.calc(32), right: screen.calc(32)),
            child: Column(
              children: items
                  .map((item) => _ListItem(
                        title: item['title'],
...
class _ListItem extends StatelessWidget {
  ...
  const _ListItem({Key key, this.artist, this.title, this.active = false})
      : super(key: key);
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Center(
          child: Text(
            '关闭',
            style: TextStyle(fontSize: screen.calc(32)),
          ),
        ),
      ),
    );
